...
public class CalculationMethods {
    ...
    public static double EquivalentFieldSize(double X, double Y){
        ...
        if( eqfs > 50){
            ...
            showAlert(Alert.AlertType.ERROR,"Input Error","Field Size Is Too Large!.");
            return 0;
        }
    ...
    public static boolean checkDepth(String depth){
        try{
            Integer dpt = Integer.valueOf(depth);
            if(dpt > 30){
                showAlert(Alert.AlertType.WARNING, "Large Depth", "No SCP/PDD value found for depth!");
                return false;
            ...
            e.printStackTrace();
            showAlert(Alert.AlertType.WARNING, "Invalid depth", "Please make sure depth is a positive real integer.");
            return false;
        }
    ...
    public static boolean checkFieldSize(double field){
        if(field > 50 || field == 0 || field < 0){
            return false;
        }else if(field == NaN){
            return false;
        }
